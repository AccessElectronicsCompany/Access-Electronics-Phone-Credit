        ...
        <div className="samsung-container">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto mb-12">
            ...
            <Card className="text-center p-6 border-2 border-black hover:bg-black hover:text-white transition-all cursor-pointer rounded-xl relative"
              ...
              <div className="absolute top-2 right-2 bg-cyan-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full">USED</div>
              <CardContent className="pt-4">
                <div className="text-3xl mb-3">🔧</div>
        ...
        <div className="samsung-container">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-3 mb-4">
              ...
              <span className="bg-cyan-500 text-white text-xs font-bold px-3 py-1 rounded-full">USED</span>
            </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="samsung-container">
          ...
          <div className="border-t border-gray-800 mt-8 pt-6 text-center">
            <p className="text-cyan-400/60 text-[10px] sm:text-xs tracking-wider mb-2 animate-tech-pulse">Powered by Innovation</p>

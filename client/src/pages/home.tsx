          ...
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden lg:flex space-x-5 xl:space-x-7 items-center animate-in slide-in-from-right duration-1000 delay-700">
              <button
                ...
                className="text-neutral-300 hover:text-cyan-400 transition-all duration-300 font-medium tracking-wider uppercase text-xs whitespace-nowrap"
              >
                Phones
              </button>
              <button
      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-cream">
        <div className="samsung-container">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-8 max-w-4xl mx-auto">
            <Card className="bg-white border border-neutral-200 text-center p-3 sm:p-5 md:p-8 animate-in slide-in-from-left duration-1000 delay-300 hover:border-cyan-400 transition-all duration-500 rounded-sm group active:scale-[0.98]" style={{ boxShadow: '0 4px 20px rgba(0, 0, 0, 0.05)' }}>
              <CardContent className="p-0 sm:pt-4">
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-cyan-500 mb-1 sm:mb-2 group-hover:scale-110 transition-transform duration-300">12</div>
            ...
            <Card className="bg-neutral-900 border border-cyan-500/30 text-center p-3 sm:p-5 md:p-8 animate-in slide-in-from-bottom duration-1000 delay-500 hover:border-cyan-400 transition-all duration-500 rounded-sm group active:scale-[0.98]" style={{ boxShadow: '0 4px 30px rgba(0, 0, 0, 0.15)' }}>
              <CardContent className="p-0 sm:pt-4">
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-cyan-400 mb-1 sm:mb-2 group-hover:scale-110 transition-transform duration-300">24</div>
                <div className="text-[10px] sm:text-xs font-medium text-cyan-400/70 mb-2 sm:mb-4 tracking-widest uppercase">Months</div>
                <div className="w-12 sm:w-16 h-0.5 mx-auto my-2 sm:my-4 bg-gradient-to-r from-transparent via-cyan-500 to-transparent hidden sm:block"></div>
            ...
            <Card className="bg-white border border-neutral-200 text-center p-3 sm:p-5 md:p-8 animate-in slide-in-from-right duration-1000 delay-700 hover:border-cyan-400 transition-all duration-500 rounded-sm group active:scale-[0.98]" style={{ boxShadow: '0 4px 20px rgba(0, 0, 0, 0.05)' }}>
              <CardContent className="p-0 sm:pt-4">
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-cyan-500 mb-1 sm:mb-2 group-hover:scale-110 transition-transform duration-300">36</div>
                <div className="text-[10px] sm:text-xs font-medium text-neutral-500 mb-2 sm:mb-4 tracking-widest uppercase">Months</div>
                <div className="luxury-divider my-2 sm:my-4 hidden sm:block"></div>
      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-neutral-900">
        <div className="samsung-container">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 max-w-6xl mx-auto">
            <Card className="text-center p-3 sm:p-4 md:p-6 bg-neutral-800/50 border border-neutral-700 hover:border-cyan-400 hover:bg-neutral-800 transition-all duration-500 cursor-pointer rounded-sm group active:scale-[0.98]"
                  onClick={() => window.location.href = '/phones'}>
              <CardContent className="p-0 pt-2 sm:pt-4">
                ...
                <h4 className="text-xs sm:text-sm md:text-base font-semibold mb-1 sm:mb-2 tracking-wider text-white group-hover:text-cyan-400 transition-colors">PHONES</h4>
            ...
            <Card className="text-center p-3 sm:p-4 md:p-6 bg-neutral-800/50 border border-neutral-700 hover:border-cyan-400 hover:bg-neutral-800 transition-all duration-500 cursor-pointer rounded-sm group active:scale-[0.98]"
              ...
              <CardContent className="p-0 pt-2 sm:pt-4">
                <div className="mb-2 sm:mb-4 flex justify-center group-hover:scale-110 transition-transform duration-300">
                  <Tablet size={24} className="sm:w-8 sm:h-8 text-white group-hover:text-cyan-400 transition-colors" />
                </div>
                <h4 className="text-xs sm:text-sm md:text-base font-semibold mb-1 sm:mb-2 tracking-wider text-white group-hover:text-cyan-400 transition-colors">IPADS</h4>
            ...
            <Card className="text-center p-3 sm:p-4 md:p-6 bg-neutral-800/50 border border-neutral-700 hover:border-cyan-400 hover:bg-neutral-800 transition-all duration-500 cursor-pointer rounded-sm group active:scale-[0.98]"
              ...
              <CardContent className="p-0 pt-2 sm:pt-4">
                <div className="text-2xl sm:text-3xl mb-2 sm:mb-4 group-hover:scale-110 transition-transform duration-300">💻</div>
                <h4 className="text-xs sm:text-sm md:text-base font-semibold mb-1 sm:mb-2 tracking-wider text-white group-hover:text-cyan-400 transition-colors">MACBOOKS</h4>
            ...
            <Card className="text-center p-3 sm:p-4 md:p-6 bg-neutral-800/50 border border-neutral-700 hover:border-cyan-400 hover:bg-neutral-800 transition-all duration-500 cursor-pointer rounded-sm group active:scale-[0.98]"
              ...
              <CardContent className="p-0 pt-2 sm:pt-4">
                <div className="text-2xl sm:text-3xl mb-2 sm:mb-4 group-hover:scale-110 transition-transform duration-300">🎧</div>
                <h4 className="text-xs sm:text-sm md:text-base font-semibold mb-1 sm:mb-2 tracking-wider text-white group-hover:text-cyan-400 transition-colors">BUDS</h4>
            ...
            <Card className="text-center p-3 sm:p-4 md:p-6 bg-neutral-800/50 border border-neutral-700 hover:border-cyan-400 hover:bg-neutral-800 transition-all duration-500 cursor-pointer rounded-sm group active:scale-[0.98]"
              ...
              <CardContent className="p-0 pt-2 sm:pt-4">
                <div className="text-2xl sm:text-3xl mb-2 sm:mb-4 group-hover:scale-110 transition-transform duration-300">⌚</div>
                <h4 className="text-xs sm:text-sm md:text-base font-semibold mb-1 sm:mb-2 tracking-wider text-white group-hover:text-cyan-400 transition-colors">WATCHES</h4>
            ...
            <Card className="text-center p-3 sm:p-4 md:p-6 bg-neutral-800/50 border border-neutral-700 hover:border-cyan-400 hover:bg-neutral-800 transition-all duration-500 cursor-pointer rounded-sm group active:scale-[0.98]"
              ...
              <CardContent className="p-0 pt-2 sm:pt-4">
                <div className="text-2xl sm:text-3xl mb-2 sm:mb-4 group-hover:scale-110 transition-transform duration-300">📱</div>
                <h4 className="text-xs sm:text-sm md:text-base font-semibold mb-1 sm:mb-2 tracking-wider text-white group-hover:text-cyan-400 transition-colors">TABLETS</h4>
            ...
            <Card className="text-center p-3 sm:p-4 md:p-6 bg-neutral-800/50 border border-neutral-700 hover:border-cyan-400 hover:bg-neutral-800 transition-all duration-500 cursor-pointer rounded-sm group active:scale-[0.98]"
              ...
              <CardContent className="p-0 pt-2 sm:pt-4">
                <div className="text-2xl sm:text-3xl mb-2 sm:mb-4 group-hover:scale-110 transition-transform duration-300">🎮</div>
                <h4 className="text-xs sm:text-sm md:text-base font-semibold mb-1 sm:mb-2 tracking-wider text-white group-hover:text-cyan-400 transition-colors">GAMING</h4>
                <p className="text-[10px] sm:text-xs text-neutral-400 hidden sm:block">PS5, Xbox & more</p>
              </CardContent>
            </Card>
            <Card className="text-center p-3 sm:p-4 md:p-6 bg-cyan-500/20 border border-cyan-500/50 hover:border-cyan-400 hover:bg-cyan-500/30 transition-all duration-500 cursor-pointer rounded-sm group active:scale-[0.98]"
                  onClick={() => scrollToSection('calculator')}>
              <CardContent className="p-0 pt-2 sm:pt-4">
                <div className="text-2xl sm:text-3xl mb-2 sm:mb-4 group-hover:scale-110 transition-transform duration-300">🧮</div>
                <h4 className="text-xs sm:text-sm md:text-base font-semibold mb-1 sm:mb-2 tracking-wider text-cyan-400">CALC</h4>
                <p className="text-[10px] sm:text-xs text-cyan-400/70 hidden sm:block">Monthly payments</p>
              </CardContent>
            </Card>
          </div>
        </div>
          ...
          <Card className="max-w-5xl mx-auto p-5 sm:p-8 md:p-10 bg-white border border-neutral-200 rounded-sm animate-in slide-in-from-bottom duration-1000" style={{ boxShadow: '0 4px 30px rgba(0, 0, 0, 0.06)' }}>
            <CardContent className="text-center p-0">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-8 mb-6 sm:mb-8">
                <div className="text-center animate-in slide-in-from-bottom duration-1000 delay-700 p-3 sm:p-4 bg-neutral-50 rounded-sm border border-neutral-100 hover:border-cyan-400/30 transition-colors active:scale-[0.98]">
                ...
                <div className="text-center animate-in slide-in-from-bottom duration-1000 delay-900 p-3 sm:p-4 bg-neutral-50 rounded-sm border border-neutral-100 hover:border-cyan-400/30 transition-colors active:scale-[0.98]">
                ...
                <div className="text-center animate-in slide-in-from-bottom duration-1000 delay-1000 p-3 sm:p-4 bg-neutral-50 rounded-sm border border-neutral-100 hover:border-cyan-400/30 transition-colors active:scale-[0.98]">
          ...
          <Card className="max-w-4xl mx-auto p-5 sm:p-8 md:p-10 bg-neutral-800 border border-neutral-700 rounded-sm animate-in slide-in-from-top duration-1000">
            <CardContent className="p-0">
              ...
              <div className="space-y-2 sm:space-y-4 mb-5 sm:mb-8">
                <div className="flex items-center gap-3 sm:gap-4 animate-in slide-in-from-left duration-1000 delay-500 p-2 sm:p-3 bg-neutral-700/30 rounded-sm border-l-2 border-cyan-500">
                ...
                <div className="flex items-center gap-3 sm:gap-4 animate-in slide-in-from-left duration-1000 delay-600 p-2 sm:p-3 bg-neutral-700/30 rounded-sm border-l-2 border-cyan-500">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-cyan-500 rounded-full flex-shrink-0"></div>
                  <p className="text-neutral-300 text-xs sm:text-base">Employment Confirmation Letter</p>
                </div>
                <div className="flex items-center gap-3 sm:gap-4 animate-in slide-in-from-left duration-1000 delay-700 p-2 sm:p-3 bg-neutral-700/30 rounded-sm border-l-2 border-cyan-500">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-cyan-500 rounded-full flex-shrink-0"></div>
                  <p className="text-neutral-300 text-xs sm:text-base">Copy of ID</p>
                </div>
                <div className="flex items-center gap-3 sm:gap-4 animate-in slide-in-from-left duration-1000 delay-800 p-2 sm:p-3 bg-neutral-700/30 rounded-sm border-l-2 border-cyan-500">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-cyan-500 rounded-full flex-shrink-0"></div>
              ...
              <div className="border-t border-neutral-700 pt-4 sm:pt-6">
                <h4 className="text-sm sm:text-lg text-cyan-400 mb-3 sm:mb-4">
      ...
      <footer className="bg-neutral-900 text-white py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="samsung-container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10 md:gap-12">
            ...
            <div className="text-center sm:text-left">
              ...
              <div className="flex space-x-3 justify-center sm:justify-start">
                <div className="w-8 h-8 sm:w-9 sm:h-9 bg-neutral-800 border border-neutral-700 rounded-sm flex items-center justify-center hover:border-cyan-400 hover:bg-neutral-800 transition-all cursor-pointer group active:scale-[0.95]">
                  <span className="text-neutral-400 text-xs sm:text-sm group-hover:text-cyan-400 transition-colors">f</span>
                </div>
                <div className="w-8 h-8 sm:w-9 sm:h-9 bg-neutral-800 border border-neutral-700 rounded-sm flex items-center justify-center hover:border-cyan-400 hover:bg-neutral-800 transition-all cursor-pointer group active:scale-[0.95]">
                  <span className="text-neutral-400 text-xs sm:text-sm group-hover:text-cyan-400 transition-colors">t</span>
                </div>
                <div className="w-8 h-8 sm:w-9 sm:h-9 bg-neutral-800 border border-neutral-700 rounded-sm flex items-center justify-center hover:border-cyan-400 hover:bg-neutral-800 transition-all cursor-pointer group active:scale-[0.95]">
                  <span className="text-neutral-400 text-xs sm:text-sm group-hover:text-cyan-400 transition-colors">@</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-2 sm:space-y-3 text-neutral-400 text-xs sm:text-sm">
                ...
                <li><a href="/phones" className="hover:text-cyan-400 transition-colors">Products</a></li>
                <li><button onClick={() => setShowCalculator(true)} className="hover:text-cyan-400 transition-colors text-left">Financing</button></li>
                <li><a href="/terms" className="hover:text-cyan-400 transition-colors">Terms</a></li>
                <li><a href="https://accessnamibia.com/" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">Online Store</a></li>
              </ul>
            </div>
            ...
            <div className="sm:col-span-2 md:col-span-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-1 gap-2 sm:gap-3 md:gap-4">
                <div className="p-3 sm:p-4 bg-neutral-800/50 border border-neutral-700/50 rounded-sm hover:border-cyan-400/30 transition-colors active:scale-[0.98]">
          ...
          <div className="border-t border-neutral-800 mt-8 sm:mt-12 pt-6 sm:pt-8 text-center">
            <p className="text-cyan-400/60 text-[10px] sm:text-xs tracking-wider mb-2 animate-tech-pulse">

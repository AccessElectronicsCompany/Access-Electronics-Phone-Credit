      ...
      <section className="samsung-section bg-white">
        <div className="samsung-container">
          <div className="text-center mb-16 animate-in slide-in-from-bottom duration-1000">
            <h2 className="text-4xl samsung-header mb-6">IPAD COLLECTION</h2>
            <p className="samsung-text text-lg">Choose from our premium iPad selection</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {ipads.map((device, index) => (

...
export default function QuoteForm({ selectedPhone }: QuoteFormProps) {
    ...
    <section id="quote-form" className="py-16 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h3 className="text-3xl font-bold text-gray-900 mb-4">Request Your Quote</h3>
          <p className="text-gray-600">Fill out the form below to get started with your phone purchase</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="text-center">
            <Button
              ...
              className="gradient-bg text-white hover:opacity-90 transition-opacity text-lg px-8 py-3 rounded-full font-semibold"
            >

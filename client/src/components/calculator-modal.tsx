    ...
    <div className="space-y-6">
      <div>
        ...
        <Input
          ...
          className="border border-neutral-300 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/20 rounded-sm h-12 bg-white transition-colors"
        />
      </div>
          ...
          <button
            ...
            className={`py-4 border rounded-sm text-center transition-all flex flex-col items-center justify-center ${
              paymentTerm === "12" 
                ...
                : "border-neutral-300 hover:border-cyan-400 bg-white text-neutral-700"
            }`}
          >
      ...
      <Button
        ...
        className="w-full py-4 h-12 bg-cyan-500 text-white hover:bg-cyan-400 rounded-sm font-medium tracking-widest uppercase text-xs transition-all"
      >
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="border-t border-neutral-200 pt-4 mt-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-bold text-cyan-500" >N${result.monthlyPayment.toFixed(2)}</span>
                </div>
              </div>
            </div>
          </CardContent>

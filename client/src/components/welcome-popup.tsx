...
const categories = [
  ...
  { label: "Combos", icon: Flame, path: "/gaming-combo", desc: "Bundle Deals" },
];
      ...
      <DialogPortal>
        ...
        >
          ...
          <div className="relative rounded-xl overflow-hidden" style={{ background: "linear-gradient(145deg, rgba(20,20,22,0.97) 0%, rgba(15,15,17,0.99) 100%)" }}>
            <div className="absolute inset-0 rounded-xl" style={{ border: "1px solid rgba(34,211,238,0.15)", pointerEvents: "none" }} />
            <div className="absolute top-0 left-0 right-0 h-[1px]" style={{ background: "linear-gradient(90deg, transparent 0%, rgba(34,211,238,0.4) 50%, transparent 100%)" }} />
            <div className="absolute -top-20 -right-20 w-40 h-40 rounded-full opacity-[0.07]" style={{ background: "radial-gradient(circle, #22d3ee 0%, transparent 70%)" }} />
            <div className="absolute -bottom-16 -left-16 w-32 h-32 rounded-full opacity-[0.05]" style={{ background: "radial-gradient(circle, #22d3ee 0%, transparent 70%)" }} />

            <div className="relative z-10 px-5 sm:px-6 pt-5 sm:pt-6 pb-3 sm:pb-4">
              <div className="flex items-center gap-2 mb-1">
                <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 animate-pulse" />
                <span className="text-[10px] sm:text-[11px] text-cyan-400/80 uppercase tracking-[0.2em] font-medium">Access Electronics</span>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className="relative flex-shrink-0">
                        <div className="absolute inset-0 rounded-md bg-cyan-500/10 blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                        <div className="relative w-8 h-8 sm:w-9 sm:h-9 rounded-md flex items-center justify-center border transition-all duration-300"
                          style={{ borderColor: "rgba(34,211,238,0.12)", background: "rgba(34,211,238,0.05)" }}
                        >
                          <Icon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-cyan-400/70 group-hover:text-cyan-400 transition-colors duration-300" />
                        </div>
                      </div>
                      ...
                      <div className="ml-auto flex-shrink-0 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-1 group-hover:translate-x-0">
                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" className="text-cyan-400/60">

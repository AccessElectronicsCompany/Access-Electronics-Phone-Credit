  ...
  return (
    <section className="relative bg-neutral-900 text-white overflow-hidden">
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-20 left-10 w-72 h-72 bg-sky-500/30 rounded-full blur-3xl animate-float"></div>
        ...
        <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-sky-600/10 rounded-full blur-2xl animate-float" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="relative samsung-section py-28 md:py-36">
        <div className="samsung-container text-center">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-8 tracking-wide" >
            <span className="text-white">BUY NOW.</span>{' '}
            <span className="text-sky-400">PAY LATER.</span>
          </h2>
          
          <p className="text-lg md:text-xl text-sky-400/80 mb-2 font-medium tracking-widest uppercase">
            Powered by FNB
          </p>
          ...
          <div className="flex items-center justify-center gap-3 mb-12 max-w-2xl mx-auto px-4">
            <div className="w-6 h-6 md:w-7 md:h-7 bg-sky-500 rounded-full flex items-center justify-center animate-glow">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-4xl mx-auto px-4">
            <Button
              ...
              className="bg-sky-500 text-neutral-900 hover:bg-sky-400 px-8 py-4 font-semibold tracking-widest uppercase text-xs transition-all rounded-sm shadow-lg shadow-sky-500/20 hover:shadow-sky-400/30"
              size="lg"
            >
              Select Phone Brand
            </Button>
            <Button
              ...
              className="bg-transparent text-sky-400 border border-sky-500/50 hover:bg-sky-500/10 hover:border-sky-400 px-8 py-4 font-semibold tracking-widest uppercase text-xs transition-all rounded-sm"
              size="lg"
            >

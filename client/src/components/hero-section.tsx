  ...
  return (
    <section className="bg-black text-white samsung-section">
      <div className="samsung-container text-center">
        <h2 className="text-5xl md:text-7xl font-black text-white mb-8 tracking-wider uppercase animate-fadeInUp">
          BUY NOW. PAY LATER. POWERED BY FNB.
        </h2>
        <p className="text-xl text-white/90 mb-6 max-w-3xl mx-auto leading-relaxed animate-fadeInUp animate-delay-200">
          Get the phone you need today and pay it off in easy monthly installments.
        </p>
        <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed animate-fadeInUp animate-delay-400">
          No hidden fees. No stress. Just fast, secure financing.
        </p>
        <div className="flex items-center justify-center gap-3 mb-12 max-w-2xl mx-auto animate-fadeInLeft animate-delay-600">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fadeInRight animate-delay-600">
          <Button

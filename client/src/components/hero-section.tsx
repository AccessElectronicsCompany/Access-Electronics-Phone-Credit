        ...
        <div className="samsung-container text-center px-4 sm:px-6">
          ...
          <div className="flex flex-col gap-3 sm:gap-4 justify-center max-w-md sm:max-w-lg md:max-w-4xl mx-auto w-full px-4 sm:px-0">
            <Button
              ...
              className="w-full bg-rose-500 text-white hover:bg-rose-400 px-4 sm:px-8 py-4 h-12 sm:h-auto font-semibold tracking-widest uppercase text-[10px] sm:text-xs transition-all rounded-sm shadow-lg shadow-rose-500/20 hover:shadow-rose-400/30"
              size="lg"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 w-full">
              <Button
                ...
                className="w-full bg-transparent text-rose-400 border border-rose-500/50 hover:bg-rose-500/10 hover:border-rose-400 px-4 sm:px-8 py-4 h-12 sm:h-auto font-semibold tracking-widest uppercase text-[10px] sm:text-xs transition-all rounded-sm"
                size="lg"
              >

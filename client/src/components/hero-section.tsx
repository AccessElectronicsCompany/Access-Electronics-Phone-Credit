  ...
  return (
    <section className="bg-black text-white samsung-section">
      <div className="samsung-container text-center">
        <h2 className="text-5xl md:text-7xl font-black text-white mb-8 tracking-wider uppercase animate-pulse">
          BUY NOW. PAY LATER. POWERED BY FNB.
        </h2>
        <p className="text-xl text-white/90 mb-6 max-w-3xl mx-auto leading-relaxed animate-bounce">
